...
const SummarizerTool = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const data = await generate({ tool: "summarizer", inputs: formData, outputCount: 1 });
          ...
          <div className="lg:col-span-2">
            <div className="border-4 border-black bg-brutalist-purple p-6 shadow-brutal-lg sticky top-24">
              ...
              <div className="space-y-6">
                ...
                <Button onClick={handleGenerate} disabled={isLoading || !formData.text.trim()} className="w-full bg-black text-white" size="lg">
